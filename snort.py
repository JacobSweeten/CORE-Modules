...
class ExampleService(CoreService):
    ...
    dirs: Tuple[str, ...] = ()
    configs: Tuple[str, ...] = ("/etc/snort/snort.debian.conf", "/etc/snort/snort.conf")
    startup: Tuple[str, ...] = tuple(f"{x}" for x in ["snort"])
    ...
    def generate_config(cls, node: CoreNode, filename: str) -> str:
        ...
        if filename == cls.configs[0]:
            cfg += f'DEBIAN_SNORT_STARTUP="boot"\n'
            cfg += f'DEBIAN_SNORT_HOME_NET="192.168.1.0/24"\n'
            cfg += f'DEBIAN_SNORT_OPTIONS=""\n'
            cfg += f'DEBIAN_SNORT_INTERFACE="eth0"\n'
